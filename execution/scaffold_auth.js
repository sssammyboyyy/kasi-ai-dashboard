...
const targetPath = path.join(__dirname, '../src/app/(auth)/login/page.tsx');
    ...
    <div className="flex h-screen w-full items-center justify-center bg-gray-50 px-4">
      <Card className="w-full max-w-sm shadow-lg">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl text-center">Kasi AI</CardTitle>
...
console.log('Created Login Page at ' + targetPath);
